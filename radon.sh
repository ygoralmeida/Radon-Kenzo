...
if [ $gestures == "y" ]; then
echo "CONFIG_WAKE_GESTURES=y" >> $KERNEL_DIR/arch/arm64/configs/kenzo_defconfig
elif [ $gestures == "n" ]; then
echo "CONFIG_WAKE_GESTURES=n" >> $KERNEL_DIR/arch/arm64/configs/kenzo_defconfig
fi
...
cd $KERNEL_DIR
head -n -1 $KERNEL_DIR/arch/arm64/configs/kenzo_defconfig > $KERNEL_DIR/arch/arm64/configs/temp
mv $KERNEL_DIR/arch/arm64/configs/temp $KERNEL_DIR/arch/arm64/configs/kenzo_defconfig
